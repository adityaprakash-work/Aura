# ---INFO-----------------------------------------------------------------------
"""
PyTitleBar widget for the application.
"""
...
from ...core import settings, assets
...
class PyTitleBar(qtw.QWidget):
    ...
    def __init__(
        ...
        def moveWindow(event):
            if parent.isMaximized():
                ...
                curso_y = event.globalPos().y() - qtg.QCursor.pos().y()
    ...
    def add_menus(self, parameters):
        if parameters != None and len(parameters) > 0:
            for parameter in parameters:
                _btn_icon = assets.set_svg_ico(parameter["btn_icon"])
        ...
        def change_ui():
            if _is_maximized:
                ...
                self.maximize_restore_button.set_icon(
                    assets.set_svg_ico("icon_restore.svg")
                )
            else:
                ...
                self.maximize_restore_button.set_icon(
                    assets.set_svg_ico("icon_maximize.svg")
                )
    ...
    def setup_ui(self):
        ...
        self.top_logo = qtw.QLabel()
        self.top_logo_layout = qtw.QVBoxLayout(self.top_logo)
        self.top_logo_layout.setContentsMargins(0, 0, 0, 0)
        self.logo_svg = qts.QSvgWidget()
        self.logo_svg.load(assets.set_svg_img(self._logo_image))
        ...
        self.minimize_button = PyTitleButton(
            ...
            text_foreground=self._text_foreground,
            radius=6,
            icon_path=assets.set_svg_ico("icon_minimize.svg"),
        )
        ...
        self.maximize_restore_button = PyTitleButton(
            ...
            text_foreground=self._text_foreground,
            radius=6,
            icon_path=assets.set_svg_ico("icon_maximize.svg"),
        )
        ...
        self.close_button = PyTitleButton(
            ...
            text_foreground=self._text_foreground,
            radius=6,
            icon_path=assets.set_svg_ico("icon_close.svg"),
        )
