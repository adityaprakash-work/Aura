# ---INFO-----------------------------------------------------------------------
"""
PyGrips widget for the application.
"""
...
class Widgets:
    def top_left(self, form):
        self.top_left_grip = qtw.QFrame(form)
    ...
    def top_right(self, form):
        self.top_right_grip = qtw.QFrame(form)
    ...
    def bottom_left(self, form):
        self.bottom_left_grip = qtw.QFrame(form)
    ...
    def bottom_right(self, form):
        self.bottom_right_grip = qtw.QFrame(form)
    ...
    def top(self, form):
        self.top_grip = qtw.QFrame(form)
        self.top_grip.setObjectName("top_grip")
        self.top_grip.setGeometry(qtc.QRect(0, 0, 500, 10))
    ...
    def bottom(self, form):
        self.bottom_grip = qtw.QFrame(form)
    ...
    def left(self, form):
        self.left_grip = qtw.QFrame(form)
        self.left_grip.setObjectName("left")
        self.left_grip.setGeometry(qtc.QRect(0, 10, 10, 480))
        self.left_grip.setMinimumSize(qtc.QSize(10, 0))
        self.left_grip.setCursor(qtg.QCursor(qtc.Qt.SizeHorCursor))
        self.left_grip.setStyleSheet("background-color: rgb(255, 121, 198);")

    def right(self, form):
        self.right_grip = qtw.QFrame(form)
        self.right_grip.setObjectName("right")
        self.right_grip.setGeometry(qtc.QRect(0, 0, 10, 500))
        self.right_grip.setMinimumSize(qtc.QSize(10, 0))
