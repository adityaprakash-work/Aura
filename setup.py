...
# ---META DATA------------------------------------------------------------------
NAME = "aura"
DESCRIPTION = "A Python package for EEG data processing and analysis."
URL = "https://github.com/adityaprakash-work/Aura.git"
EMAIL = "adityaprakash.work@gmail.com"
AUTHOR = "Aditya Prakash"
REQUIRES_PYTHON = ">=3.9.0"
VERSION = "0.5.0"
REQUIRED = ["einops", "tqdm", "lightning", "mne", "torchmetrics"]
EXTRAS = {}
